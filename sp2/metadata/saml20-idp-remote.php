...
$metadata['https://proxy.tutorial.stack-dev.cirrusidentity.com/saml2/idp/metadata.php'] = array (
  'metadata-set' => 'saml20-idp-remote',
  'entityid' => 'https://proxy.tutorial.stack-dev.cirrusidentity.com/saml2/idp/metadata.php',
  'SingleSignOnService' =>
  array (
    0 =>
    array (
      'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect',
      'Location' => 'https://proxy.tutorial.stack-dev.cirrusidentity.com/saml2/idp/SSOService.php',
    ),
  ),
  'SingleLogoutService' =>
  array (
    ...
    array (
      'Binding' => 'urn:oasis:names:tc:SAML:2.0:bindings:HTTP-Redirect',
      'Location' => 'https://proxy.tutorial.stack-dev.cirrusidentity.com/saml2/idp/SingleLogoutService.php',
    ),
  ),
